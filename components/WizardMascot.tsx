...
/**
 * SignalSage Witch Mascot — SVG illustration
 */
export default function WizardMascot({ reaction = 'idle', size = 'md' }: WizardMascotProps) {
  const sizeMap = { sm: 32, md: 40, lg: 64 };
  const containerSizeMap = { sm: 'w-10 h-10', md: 'w-14 h-14', lg: 'w-24 h-24' };
  const gooBadgeSizeMap = { sm: 'w-9 h-9', md: 'w-12 h-12', lg: 'w-20 h-20' };
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${containerSizeMap[size]}`}>
      ...
      >
        <path d="M32 2L22 26h20L32 2z" fill="url(#hatGradient)" stroke="#7c3aed" strokeWidth="0.5" />
        ...
        <path d="M23 26c-2 4-3 10-1 16" stroke="url(#hairGradient)" strokeWidth="3" strokeLinecap="round" fill="none" />
        <path d="M41 26c2 4 3 10 1 16" stroke="url(#hairGradient)" strokeWidth="3" strokeLinecap="round" fill="none" />
        <path d="M25 27c-1 5-2 8 0 14" stroke="url(#hairGradient)" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.7" />
        <path d="M39 27c1 5 2 8 0 14" stroke="url(#hairGradient)" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.7" />
        ...
        <path d="M24 44c0 0-4 8-6 18h28c-2-10-6-18-6-18" fill="url(#cloakGradient)" opacity="0.9" />
        <defs>
